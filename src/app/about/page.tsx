        ...
        <>
            <section className="container pt-2" data-aos="fade-in">
                <div>
                    ...
                    <SectionDescription>
                        ...
                        Google Developer Groups (GDGs) ao redor do mundo. Esses eventos, organizados
                        pela comunidade, focam em aprendizado, construção de projetos e conexão
                        entre desenvolvedores e profissionais de tecnologia. As atividades
                        oferecidas incluem palestras técnicas, workshops práticos e oportunidades de
                        networking, proporcionando um ambiente rico para o desenvolvimento
                        profissional e a troca de conhecimento.
                    </SectionDescription>
                    <div className="pt-6">
                        <SectionDescription>
                            Estamos empolgados em anunciar a sexta edição do DevFest em Belo
                            Horizonte! Desde a sua primeira edição em 2015, o DevFest BH tem sido um
                            evento crucial para a comunidade de desenvolvedores da região, crescendo
                            a cada ano em tamanho e impacto.
                        </SectionDescription>
                    </div>
                </div>
            </section>
            ...
            <div className="bg-dark-background my-12">
                <section className="container flex flex-col text-white gap-8 items-center align-middle md:flex-row md:gap-16 py-6">
                    <SectionDescription>
                        O que é o GDG: Somos o Google Developer Groups de Belo Horizonte (GDG BH),
                        uma comunidade apaixonada por tecnologia que se reúne para{' '}
                        <b>aprender, compartilhar e construir juntos</b>. Como parte da rede global
                        GDG, fazemos parte de uma comunidade com mais de{' '}
                        <b>10.000 grupos em mais de 170 países</b>, oferecendo uma ampla variedade
                        de eventos e atividades emocionantes, incluindo{' '}
                        <b>meetups, hackathons, workshops e conferências.</b>
                    </SectionDescription>
