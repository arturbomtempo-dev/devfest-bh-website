            ...
            {events.map((el, i) => (
                <div key={i} className="flex flex-row lg:flex-col">
                    <div className="flex justify-center align-middle relative lg:hidden">
                        <div
                            className="bg-gray-900 rounded-full top-1/2 w-3 h-3 absolute"
                            data-aos="fade-down"
                        ></div>
                    </div>
                    ...
                    <div
                        ...
                        className="w-2/3 md:w-full cursor-pointer h-40 flex items-center justify-center pl-4 lg:pl-0 lg:pb-12"
                    >
                    ...
                    <div className="flex flex-col align-middle justify-center pl-2">
                        <h4
                            className="pt-2 lg:pt-6 lg:pb-4 text-center font-black text-3xl text-zinc-800"
                            data-aos="zoom-in"
                        >
                            {el.year}
                        </h4>
