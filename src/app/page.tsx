...
export default function Home() {
    ...
    return (
        <>
            ...
            <section
                className="container py-8 px-4 flex flex-col text-center lg:w-full lg:flex-row lg:items-center"
                data-scroll
            >
                <div
                    data-scroll
                ...
                >
                    ...
                    <div className="gap-2">
                        <SectionDescription>
                            ...
                            <b>Google Developer Groups (GDGs)</b> ao redor do mundo. Esses eventos,
                            organizados pela comunidade, focam em aprendizado, construção de
                            projetos e conexão entre desenvolvedores e profissionais de tecnologia.
                            As atividades oferecidas incluem{' '}
                            <b>
                                palestras técnicas, workshops práticos e oportunidades de networking
                            </b>
                            , proporcionando um ambiente rico para o desenvolvimento profissional e
                            a troca de conhecimento.
                        </SectionDescription>
                        <SectionDescription>
                            Estamos empolgados em anunciar a{' '}
                            <b>sexta edição do DevFest em Belo Horizonte!</b> Desde a sua primeira
                            edição em 2015, o DevFest BH tem sido um evento crucial para a
                            comunidade de desenvolvedores da região, crescendo a cada ano em tamanho
                            e impacto.
                        </SectionDescription>
                    </div>
                </div>
                ...
                <section className="container pt-8 pb-16 fade-right" data-scroll>
                    ...
                    <div className="flex justify-center md:-ml-24 -ml-12">
                        <FontAwesomeIcon
                            ...
                            className="text-9xl text-red -mr-8"
                        />
                        <FontAwesomeIcon
                            icon={faCircleQuestion}
                            className="text-9xl text-yellow -mr-8"
                        />
                        <FontAwesomeIcon
                            icon={faCircleQuestion}
                            className="text-9xl text-blue -mr-8"
                        />
                    </div>
                </section>
            </div>
                ...
                <section className="container py-12 px-4 flex flex-col text-center  lg:w-full lg:flex-row lg:items-center">
                    <div className="h-full mb-10 lg:mb-0 lg:mr-10 lg:w-full lg:text-justify ">
                        ...
                        <SectionDescription>
                            ...
                            para saber mais sobre as oportunidades de parceria e como sua empresa
                            pode se envolver.
                        </SectionDescription>
                    </div>
                </section>
            ...
            <div className="py-16 bg-dark-background md:py-0" id="maps">
                <section className="container h-32 text-white flex flex-col justify-between items-center md:flex-row">
                    ...
                    <div className="text-center text-sm flex flex-col gap-1 md:text-left md:text-base">
                        ...
                        >
                            <strong>Local:</strong> Puc Minas Lourdes Av. Brasil, 2023 -
                            Funcionários
                        </a>
                    </div>
                </section>
